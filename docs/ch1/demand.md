...
=== "需求量的移動"
    ![需求量的移動](images/需求—點的移動.png){ width="350" }

=== "需求的變動"
    ![需求的變動](images/需求—線的移動.png){ width="350" }
...
![需求曲線 (離散)](images/需求曲線-1.png){ width="350" }

如果描述需求的方法並非離散而是連續，則繪製的需求曲線是一個平滑的曲線。

![需求曲線 (連續)](images/需求曲線-2.png){ width="350" }
...
![市場需求曲線](images/市場需求線.png){ width="700" }
...
![消費者剩餘](images/消費者剩餘.png){ width="350" }
